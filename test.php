<?php
/*
Plugin Name: Your Social Media Profiles By Hot Web Ideas
Plugin URI: http://www.hotwebideas.net/wordpressplugins.php
...
class Networks
{
	...
	public function displayNetworkTable($profile)
	{
		...
		$html = ('
			<tr valign="top">
			<td><img width="32" src="http://www.longislandblogposts.com/images/socialmedia/' . $profile . '.png" /></td>
