...
Plugin Name: Your Social Media Profiles By G.M.Paryani.
Description: Displays a new page in your WordPress admin settings that will allow you to enter your social media profiles. The icons for those social networks will appear on the top of your blog posts and pages. Use the SocialMediaProfiles()
Version: 1.0
...
add_action('widget_init', 'register_msmp_widget');
...
class sbw extends WP_Widget {
  ...
  function sbw() {
    ...
    $options = array(
      ...
      'description' => 'Displays your social media icons form your Social Media Icons Profiles by G.M.Paryani Plugin.',
    );
...

{
...

    {
      ...
      <img width="32" src="http://www.longislandblogposts.com/images/socialmedia/' . $profile . '.png"/>
      </a>
      ');
    ...
    return $html;
      ...
      function my_plugin_menu() {
          ...
          add_option_page('Your Social Media Profiles', 'Your Social Media Profiles by G.M. Paryani', 'make_options', 'GMParyani_SocialMediaProfiles', 'my_plugin_options');
      ...
      <div class="wrap">
        ...
        // Method for displaying social media Icons
